...
export const DEFAULT_PARTNERS: PartnerStudio[] = [
  {
    ...
    logo: 'https://static.wixstatic.com/media/7ffb5e_874ebf7ce2e44d32b509bc0c572a15bb~mv2.png/v1/fill/w_180,h_180,al_c,q_85,enc_avif,quality_auto/leoceo.png',
  ...
  },
  {
    ...
    logo: 'https://static.wixstatic.com/media/7ffb5e_e7d7040d347c43dcbe29737f2679c135~mv2.png/v1/fill/w_220,h_100,al_c,q_85,enc_avif,quality_auto/cinerva.png',
    region: 'Global Network',
    speciality: 'VFX Support & Rotoscopy',
    artistCount: 45,
    status: 'ACTIVE',
  ...
  {
    studioName: 'Black Fxtudio',
    email: 'tom@blackfx.net',
    website: 'https://blackfx.net',
    logo: 'https://static.wixstatic.com/media/7ffb5e_bebd8db90704414a9140cfbf0e8fe1e1~mv2.png/v1/fill/w_217,h_217,al_c,q_85,usm_0.66_1.00_0.01,enc_avif,quality_auto/RPW.png',
    region: 'Global Hub',
    speciality: 'Lead VFX Support & Supervision',
    artistCount: 35,
    status: 'ACTIVE',
  },
];
